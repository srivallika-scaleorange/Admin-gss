...
// // PaymentReceiptPDF Component (unchanged)
...
//     status: '',
//     date: '',
//     payment_type: '', // Added filter for payment type
//   });
...
//       // Fetch all payments (including one-time payments)
...
//       showNotification('No valid image available for this payment', 'error');
//       return;
//     }
//     setSelectedImage({
//       src: imageData,
...
const EMIPayments = () => {
  ...
  // Test button for debugging image dialog
  const handleTestImage = () => {
    setSelectedImage({
      src: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAABAAAAAQAAAAEAAAB4BAgAAAAC0lEQVR4nGP4DwQMACYAFX/P2AAAAABJRU5ErkJggg==', // Tiny base64 image
      paymentId: 'test',
