...
//   return (
//     <Box sx={{ minHeight: '100vh', bgcolor: 'transparent', p: 3 }}>
//       {/* Header */}
...
//         {/* Search Filters */}
//         <Paper sx={{ p: 2, mb: 3, border: '1px solid #e5e7eb', borderRadius: 2, bgcolor: '#ffffff' }}>
...
//           <Paper sx={{ p: 4, textAlign: 'center', border: '1px solid #e5e7eb', borderRadius: 2, bgcolor: '#ffffff' }}>
//             <Box sx={{ bgcolor: '#f8fafc', borderRadius: 2, p: 3, mx: 'auto', width: 96, height: 96, display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 2, border: '1px solid #e5e7eb' }}>
//               <NotificationsIcon sx={{ fontSize: 48, color: '#6b7280' }} />
//             </Box>
...
//           </Paper>
//         ) : (
//           <TableContainer component={Paper} sx={{ border: '1px solid #e5e7eb', borderRadius: 2, bgcolor: '#ffffff' }}>
//             <Table>
//               <TableHead>
